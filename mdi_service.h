...
uint32_t    ble_midi_service_init(ble_midi_service_t *p_midi_service, ble_midi_service_init_t *p_midi_service_init);

void ble_midi_on_ble_evt(ble_midi_service_t *p_midi_service, ble_evt_t *p_ble_evt);
